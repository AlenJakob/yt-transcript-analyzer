...
const PRESETS: PromptPreset[] = [
  {
    ...
    description: 'Generuje zwięzłe podsumowanie w 3-5 kluczowych zdaniach z najważniejszym wnioskiem.',
  ...
  },
  {
    ...
    description: 'Analizuje język pod kątem technik erystycznych, FOMO, obietnic bez pokrycia i manipulacji.',
    ...
    >
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" sx={{ color: 'text.secondary' }}>
          Wybierz gotowy szablon zapytania, skopiuj go jednym kliknięciem (z automatycznie dołączoną transkrypcją) lub przetestuj symulację analizy bezpośrednio tutaj.
        </Typography>
      </Box>
            ...
            <Grid size={{ xs: 12, sm: 6, md: 4 }} key={preset.id}>
              ...
              >
                <CardContent sx={{ p: 2.5, display: 'flex', flexDirection: 'column', height: '100%' }}>
                  ...
                  <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '0.85rem', flexGrow: 1, mb: 2 }}>
                    {preset.description}
                  </Typography>
                  <Button
      ...
      <Box sx={{ bgcolor: '#0a0d14', p: 3, borderRadius: 3, border: '1px solid rgba(255, 255, 255, 0.06)' }}>
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} sx={{ justifyContent: 'space-between', alignItems: { sm: 'center' }, mb: 2.5 }}>
          <Box>
            <Typography variant="subtitle1" sx={{ fontWeight: 700, display: 'flex', alignItems: 'center', gap: 1 }}>
              Podgląd analizy dla: <Chip label={activePreset.title} size="small" sx={{ bgcolor: 'rgba(255, 255, 255, 0.08)', fontWeight: 600 }} />
            </Typography>
          ...
          <Button
            variant="contained"
            startIcon={isSimulating ? <CircularProgress size={16} color="inherit" /> : <PlayArrowIcon />}
        ...
        {simulationResult ? (
          ...
          >
            ...
            <Typography variant="body2">
              Kliknij <strong>&quot;Generuj Symulację AI&quot;</strong>, aby zobaczyć jak wyglądałaby analiza ChatGPT / Claude dla tego filmu.
            </Typography>
          </Box>
        )}
      </Box>
      ...
      >
        <Alert severity="success" icon={<CheckCircleIcon fontSize="small" />} sx={{ width: '100%', borderRadius: 2 }}>
          {snackbarMessage}
        </Alert>
      </Snackbar>
    </Paper>
