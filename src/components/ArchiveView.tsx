      ...
      >
        ...
        >
          ...
          <Stack
            direction="row"
            spacing={1.5}
            sx={{ alignItems: 'center', justifyContent: 'space-between', width: { xs: '100%', md: 'auto' } }}
          >
              ...
              >
                <CardContent sx={{ p: 2, '&:last-child': { pb: 2 } }}>
                  ...
                  <Stack direction="row" spacing={1} sx={{ mb: 2, gap: 0.5, flexWrap: 'wrap' }}>
                    <Chip
                      icon={<CalendarTodayIcon sx={{ fontSize: 12, color: '#9ca3af !important' }} />}
                    ...
                    <Chip
                      ...
                      size="small"
                      sx={{ bgcolor: 'rgba(59, 130, 246, 0.1)', color: '#60a5fa', fontSize: '0.72rem' }}
                    />
                  </Stack>

                  {/* Akcje pod spodem */}
                  <Stack direction="row" spacing={1} sx={{ alignItems: 'center', justifyContent: 'space-between', pt: 1, borderTop: '1px solid rgba(255, 255, 255, 0.06)' }}>
                    <Button
                      variant="contained"
                      size="small"
      ...
      >
        ...
        <DialogContent>
          <DialogContentText sx={{ color: 'text.secondary' }}>
            Czy na pewno chcesz usunąć wszystkie zapisane transkrypcje ({history.length} wideo) z pamięci lokalnej? Ta akcja jest nieodwracalna.
          </DialogContentText>
        </DialogContent>
