            ...
            {!metadata && !isLoading && (
              ...
              >
                ...
                <Typography variant="body2" sx={{ color: 'text.secondary', maxWidth: 500, mx: 'auto', mb: 3 }}>
                  Wklej dowolny adres URL z serwisu YouTube w powyższym polu lub otwórz wcześniej zapisaną transkrypcję z zakłdaki <strong>Archiwum ({history.length})</strong>.
                </Typography>
                <Typography variant="caption" sx={{ color: 'text.disabled', display: 'inline-flex', alignItems: 'center', gap: 0.5 }}>
                  <InfoIcon sx={{ fontSize: 16 }} /> Obsługuje filmy wideo, YouTube Shorts oraz linki skrócone `youtu.be`.
                </Typography>
              </Paper>
            )}
          </>
